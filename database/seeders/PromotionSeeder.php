...
class PromotionSeeder extends Seeder
{
    ...
    {
        $skus = [
            'SNK-002', 'BEB-001', 'LAC-001', 'LAC-005', 'GRA-003',
        ];
        ...
        $promotions = [
            [
                ...
                'type'        => 'buy_x_get_y',
                'conditions'  => [
                    'buy_product_id' => $products->get('SNK-002')?->id,
                    'buy_qty'        => 2,
                ],
                'rewards'     => [
                    'get_product_id' => $products->get('SNK-002')?->id,
                    'get_qty'        => 1,
                    'discount_pct'   => 100,
                ],
                'priority'    => 10,
            ...
            [
                ...
                'conditions'  => [
                    'product_id'   => $products->get('BEB-001')?->id,
                    'min_qty'      => 6,
                    'discount_pct' => 20,
                ],
                'rewards'     => [],
            ...
            [
                ...
                'conditions'  => [
                    'product_ids'  => [
                        $products->get('LAC-001')?->id,
                        $products->get('LAC-005')?->id,
                        $products->get('GRA-003')?->id,
                    ],
                    'discount_pct' => 15,
                ],
                'rewards'     => [],
