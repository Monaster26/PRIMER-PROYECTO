...
function selectDay(day: number) {
    ...
    emit('select', {
        dia: day,
        mes: calendarMonth.value + 1,
        anio: calendarYear.value,
    });
    isOpen.value = false;
}
...
<template>
    <div ref="wrapperRef" class="date-filter-wrapper relative">
        ...
        >
            <svg
                class="h-3.5 w-3.5 flex-shrink-0 text-content-muted"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            >
            ...
            <svg
                class="h-3 w-3 flex-shrink-0 text-content-muted transition-transform"
            ...
            >
                ...
                >
                    <div class="mb-2 flex items-center justify-between">
                        ...
                        <span
                            class="select-none text-[11px] font-bold text-content-primary dark:text-white"
                        >
                            {{ monthYearLabel }}
                        </span>
                        <button
                    ...
                    <div
                        class="mt-2 border-t border-gray-100 pt-2 dark:border-gray-700"
                    >
                        <button
                            type="button"
