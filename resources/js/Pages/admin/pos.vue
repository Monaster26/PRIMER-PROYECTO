...
const sessionOpened = ref(
    localStorage.getItem('pos_session_opened') === 'true' ||
...
const desgloseAnterior = computed(
    () =>
        ...
        props.ultimaSesion?.cierre_desglose ??
        null,
);
    ...
    <AdminLayout>
        ...
        >
            <div class="w-full max-w-5xl">
                ...
                >
                    ...
                    <form
                        @submit.prevent="submitOpenSession"
                        class="space-y-4 p-5"
                    >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span
                                        ...
                                        >{{ props.ultimaSesion?.cerrado_por }} ·
                                        {{
                                            props.ultimaSesion?.cerrado_at
                                        }}</span
                                    >
                                </div>
        ...
        <div v-if="sessionOpened">
            ...
            <div class="flex h-[calc(100vh-10rem)] gap-4">
                ...
                >
                    <div
                        class="relative mb-2 flex items-center justify-between"
                    >
                        <h3
                        ...
                        >
                            ...
                            <div class="relative flex-[2]">
                                ...
                                <input
                                    ...
                                    @focus="
                                        onPaymentFocus($event, payment.method)
                                    "
                                    type="number"
                                    min="0"
                                    step="100"
                    ...
                    <div class="space-y-4 p-5">
                        ...
                        >
                            ...
                            <strong
                                ...
                                >{{ fmt(discrepancyData?.diferencia) }}</strong
                            >.
                        </p>
                        ...
                        <div class="flex gap-2">
                            ...
                            <button
                                @click="confirmOpenWithDiscrepancy"
